        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-1 no-padding-right">
                        <a  class="white" href="${pageContext.request.contextPath}/practiceImport.action">
                ...
                <div class="row">
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input   class="form-control" name="practiceName" id="name" type="text" placeholder="项目名称"  />
                                </div>
                    ...
                    <div class="col-xs-12" id="addForm" style="display: none">
                        <h4 class="pink" style="height: 20px"></h4>
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/addPracticeType.action" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right " for="addDate">项目时间</label>
                                <div class="col-sm-1">
                                    <select id="addDate" class="form-control"   name="practicetime" readonly>
                                    </select>
                                </div>
                                <label class="col-sm-1 control-label no-padding-right"  for="addPracticeName">
                                    项目名称
                                </label>
                                <div class="col-sm-1">
                    ...
                    <div class="col-xs-12" id="importForm" style="display: none">
                        <h4 class="pink" style="height: 20px"></h4>
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/practiceExcelImport.action"  method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-1 no-padding-top">
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination middle">
                            ...
                            <li >
                                ...
                                <a href="${pageContext.request.contextPath}/practiceImport.action?currentPage=${pageBean.currentPage-1}&practiceName=${practiceName}&practiceTime=${practiceTime}"> <i class="ace-icon fa fa-caret-left bigger-140 middle"></i> </a>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/practiceImport.action?currentPage=${pageBean.currentPage+1}&practiceName=${practiceName}&practiceTime=${practiceTime}">
                                    <i class="ace-icon fa fa-caret-right bigger-140 middle"></i>
                                </a>
                            </li>

                            <li>
                                <a href="${pageContext.request.contextPath}/practiceImport.action?currentPage=${pageBean.totalPage}&practiceName=${practiceName}&practiceTime=${practiceTime}">
...
<script type="text/javascript">
    ...
    function download(){
        var url="download_practice.action?id=10&name=暑期社会实践信息导入";
        window.open(url);
    }
</script>
</body>
