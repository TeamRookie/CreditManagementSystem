        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-1 no-padding-right">
                        <a  class="white" href="${pageContext.request.contextPath}/associationImport.action">
                ...
                <div class="row">
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/associationImport.action" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"  for="name">
                                    社团名称
                                </label>
                                <div class="col-sm-2">
                                    <input   class="form-control" name="associationName" id="name" type="text" placeholder="社团名称" />
                                </div>
                                <label class="col-sm-1 control-label no-padding-right " for="date">时间</label>
                                <div class="col-sm-2">
                                        <select id="date" class="form-control"   name="associationTime" readonly>
                                        </select>
                                </div>
                    ...
                    <div class="col-xs-12" id="addForm" style="display: none">
                        <h4 class="pink" style="height: 20px"></h4>
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/addAssociationType.action" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right " for="addDate">时间</label>
                                <div class="col-sm-1">
                                    <select id="addDate" class="form-control"   name="associationtime" readonly>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-1">
                                    <input   class="form-control" name="associationname" id="addProjectName" type="text" placeholder="项目名称" required />
                                </div>

                                <label class="col-sm-1 control-label no-padding-right"  for="addLevel">
                                    社团级别
                                </label>
                                <div class="col-sm-1">
                                    <select id="addLevel" class="form-control"   name="associationlevel" readonly>
                                        ...
                                        <option value="示范社团">示范社团</option>
                                        <option value="特色社团">特色社团</option>
                                        <option value="注册社团">注册社团</option>
                                    </select>
                                </div>
                ...
                <%--<div class="pull-left"> ${orderCount} messages total</div>--%>
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination middle">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/associationImport.action?currentPage=1&associationName=${associationName}&associationTime=${associationTime}"><i class="ace-icon fa fa-step-backward middle"></i></a>
                            </li>

                            <li >

                                <a href="${pageContext.request.contextPath}/associationImport.action?currentPage=${pageBean.currentPage-1}&associationName=${associationName}&associationTime=${associationTime}"> <i class="ace-icon fa fa-caret-left bigger-140 middle"></i> </a>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/associationImport.action?currentPage=${pageBean.currentPage+1}&associationName=${associationName}&associationTime=${associationTime}">
                                    <i class="ace-icon fa fa-caret-right bigger-140 middle"></i>
                                </a>
                            </li>

                            <li>
                                <a href="${pageContext.request.contextPath}/associationImport.action?currentPage=${pageBean.totalPage}&associationName=${associationName}&associationTime=${associationTime}">
