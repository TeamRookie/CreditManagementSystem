        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-1 no-padding-right">
                        <a  class="white" href="${pageContext.request.contextPath}/projectImport.action">
                ...
                <div class="row">
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/projectImport.action" method="post">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"  for="name">
                                    项目名称
                                </label>
                                <div class="col-sm-2">
                                    <input   class="form-control" name="projectName" id="name" type="text" placeholder="项目名称" />
                                </div>
                    ...
                    <div class="col-xs-12" id="addForm" style="display: none">
                        <h4 class="pink" style="height: 20px"></h4>
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/addProjectType.action" method="post">
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right " for="addDate">项目时间</label>
                                <div class="col-sm-1">
                                    <select id="addDate" class="form-control"   name="projecttime" readonly>
                                    </select>
                                </div>
                                <label class="col-sm-1 control-label no-padding-right"  for="addProjectType">
                                    项目类别
                                </label>
                                <div class="col-sm-1">
                                    <select id="addProjectType" class="form-control"   name="type" readonly>
                                ...
                                <div class="col-sm-1">
                                    <input   class="form-control" name="projectname" id="addProjectName" type="text" placeholder="项目名称" required />
                                </div>

                                <label class="col-sm-1 control-label no-padding-right"  for="addProjectId">
                                    项目编号
                                </label>
                                <div class="col-sm-1">
                    ...
                    <div class="col-xs-12" id="importForm" style="display: none">
                        <h4 class="pink" style="height: 20px"></h4>
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/projectExcelImport.action"  method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-1 no-padding-top">
                ...
                <%--<div class="pull-left"> ${orderCount} messages total</div>--%>
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination middle">
                            <li>
                                <a href="${pageContext.request.contextPath}/projectImport.action?currentPage=1&projectName=${projectName}&projectTime=${projectTime}"><i class="ace-icon fa fa-step-backward middle"></i></a>
                            </li>

                            <li >

                                <a href="${pageContext.request.contextPath}/projectImport.action?currentPage=${pageBean.currentPage-1}&projectName=${projectName}&projectTime=${projectTime}"> <i class="ace-icon fa fa-caret-left bigger-140 middle"></i> </a>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/projectImport.action?currentPage=${pageBean.currentPage+1}&projectName=${projectName}&projectTime=${projectTime}">
