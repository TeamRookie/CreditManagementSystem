                    ...
                    <div class="message-footer clearfix">
                        ...
                        <div class="pull-right">
                            ...
                            <ul class="pagination middle">
                                <li>
                                    <a href="${pageContext.request.contextPath}/patentsRules.action?currentPage=1"><i class="ace-icon fa fa-step-backward middle"></i></a>
                                </li>

                                <li >

                                    <a href="${pageContext.request.contextPath}/patentsRules.action?currentPage=${pageBean.currentPage-1}"> <i class="ace-icon fa fa-caret-left bigger-140 middle"></i> </a>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/patentsRules.action?currentPage=${pageBean.currentPage+1}">
                                        <i class="ace-icon fa fa-caret-right bigger-140 middle"></i>
                                    </a>
                                </li>

                                <li>
                                    <a href="${pageContext.request.contextPath}/patentsRules.action?currentPage=${pageBean.totalPage}">
