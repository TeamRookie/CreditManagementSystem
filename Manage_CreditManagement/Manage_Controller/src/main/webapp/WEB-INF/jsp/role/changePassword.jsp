        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form id="changePasswordForm" class="form-horizontal" role="form" action="${pageContext.request.contextPath}/changePassword.action" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input  required onchange="errorHidden();" id="password" name="password" type="password"  placeholder="原密码" class="col-xs-10 col-sm-5" />
    ...
    function errorHidden(){
        ...
        function  changePassword() {
            ...
            if(checkOne&&checkTwo)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath}/changePasswordById.action",
