        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">    <a href="#">学生社团</a></li>
                </ul>
            ...
            <div class="page-content">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-1 no-padding-right">
                        <a  class="white" href="${pageContext.request.contextPath}/association.action">
                ...
                <div class="row">
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/association.action">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right"  for="associationName">
                                    社团名称
                                </label>
                                <div class="col-sm-2">
                                    <input   class="form-control" name="associationName" id="associationName" type="text" placeholder="社团名称"  />
                                </div>
                                <label class="col-sm-1 control-label no-padding-right " for="date">创建时间</label>
                                <div class="col-sm-1">
                                    <select id="date" class="form-control"   name="associationTime" readonly>
                                    </select>
                                </div>
                                <label class="col-sm-1 control-label no-padding-right " for="associationLevel">社团级别</label>
                                <div class="col-sm-1">
                                    <select id="associationLevel" class="form-control"   name="associationLevel" readonly>
                                        <option value="">请选择</option>
                                        <option value="5星级社团">5星级社团</option>
                                        <option value="4星级社团">4星级社团</option>
                                        <option value="3星级社团">3星级社团</option>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover text-nowrap">
                    ...
                    <c:forEach items="${pageBean.pageList}" var="item">
                            <tr>
                                ...
                                <td class="center">${item.associationtime}</td>
...
<script type="text/javascript">
    ...
    function importInformation()
    {
        ...
        var  associationLevel=$("#associationLevel").val();
        var  date=$("#date").val();
        var associationName=$("#associationName").val();

        var url="associationDownload.action?"+"faculty="+faculty+"&"+"major="+major+"&"+"grade="+grade+"&"+"date="+date+"&"+"name=大学生创新创业训练项目"+"&"+"associationLevel="+associationLevel+"&"+"associationName="+associationName;
        window.open(url);
    }
</script>
</body>
