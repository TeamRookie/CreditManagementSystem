                    ...
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input   class="form-control" name="associationName" id="contestName" type="text" placeholder="社团名称"  />
                                </div>
                                ...
                                <label class="col-sm-1 control-label no-padding-right " for="level">社团级别</label>
                                <div class="col-sm-1">
                                    <select id="level" class="form-control"   name="associationLevel" readonly>
