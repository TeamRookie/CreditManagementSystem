                ...
                <div class="row">
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/train.action">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <select id="date" class="form-control"   name="trainTime" readonly>
                                    </select>
                                </div>
                                <label class="col-sm-1 control-label no-padding-right"  for="trainContent">
                                    培训内容
                                </label>
                                <div class="col-sm-2">
                                    <select id="trainContent" class="form-control"   name="trainContent" readonly>
                                    </select>
                                </div>
            ...
            <div class="table-responsive">
                <table id="dynamic-table" class="table table-striped table-bordered table-hover text-nowrap">
                    ...
                    <tr>
                        ...
                        <th class="center">校内组织单位</th>
                        <th class="center">负责教师</th>
...
<script type="text/javascript">
    ...
    function importInformation()
    {
        ...
        var  date=$("#date").val();
        var url="trainDownload.action?"+"faculty="+faculty+"&"+"major="+major+"&"+"grade="+grade+"&"+"date="+date+"&"+"name=大学生创新创业训练项目"+"&"+"trainContent="+trainContent;
        window.open(url);
    }
</script>
</body>
