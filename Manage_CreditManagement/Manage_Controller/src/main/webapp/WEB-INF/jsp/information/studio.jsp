                    ...
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label no-padding-right " for="studioLevel">工作室等级</label>
                                <div class="col-sm-1">
...
<script type="text/javascript">
    ...
    function importInformation()
    {
        ...
        var  studioLevel=$("#studioLevel").val();
        var  studioDepartment=$("#studioDepartment").val();
        var grade=$("#grade").val();
        if(grade==null)
        {
            grade="";
        ...
        var url="studioDownload.action?"+"faculty="+faculty+"&"+"major="+major+"&"+"grade="+grade+"&"+"studioTime="+date+"&"+"name=大学生创新创业训练项目"+"&"+"studioLevel="+studioLevel+"&"+"studioName="+studioName+"&"+"department="+studioDepartment;
        window.open(url);
    }
</script>
</body>
