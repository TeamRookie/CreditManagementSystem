        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">      <a href="#">大学生创新创业训练项目</a></li>
                </ul>
            ...
            <div class="page-content">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-sm-1 no-padding-right">
                        <a  class="white" href="${pageContext.request.contextPath}/practice.action">
                ...
                <div class="row">
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/practice.action">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label no-padding-right"  for="practiceName">
                                    项目名称
                                </label>
                                <div class="col-sm-2">
                                    <input   class="form-control" name="practiceName" id="practiceName" type="text" placeholder="竞赛名称"  />
                                </div>

                                <label class="col-sm-1 control-label no-padding-right " for="date">项目时间</label>
                                <div class="col-sm-1">
                                    <select id="date" class="form-control"   name="practiceTime" readonly>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select id="practiceScore" class="form-control"   name="practiceScore" readonly>
                                        <option value="">请选择</option>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover text-nowrap">
                    ...
                    <c:forEach items="${pageBean.pageList}" var="item">
                            <tr>
                                ...
                                <td class="center">${item.practicetime}</td>
                                <td class="center">${item.practicetype}</td>

                                <td class="center">${item.practicename}</td>
                                <td class="center">${item.practicelevel}</td>
                ...
                <%--<div class="pull-left"> ${orderCount} messages total</div>--%>
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination middle">
                            <li>
                                <a href="${pageContext.request.contextPath}/project.action?currentPage=1&studentNumber=${studentNumber}&projectId=${projectId}&projectLevel=${projectLevel}&projectScore=${projectScore}&projectTime=${projectTime}&projectType=${projectType}"><i class="ace-icon fa fa-step-backward middle"></i></a>
                            </li>

                            <li >

                                <a href="${pageContext.request.contextPath}/project.action?currentPage=${pageBean.currentPage-1}&studentNumber=${studentNumber}&projectId=${projectId}&projectLevel=${projectLevel}&projectScore=${projectScore}&projectTime=${projectTime}&projectType=${projectType}"> <i class="ace-icon fa fa-caret-left bigger-140 middle"></i> </a>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/project.action?currentPage=${pageBean.currentPage+1}&studentNumber=${studentNumber}&projectId=${projectId}&projectLevel=${projectLevel}&projectScore=${projectScore}&projectTime=${projectTime}&projectType=${projectType}">
                                    <i class="ace-icon fa fa-caret-right bigger-140 middle"></i>
                                </a>
                            </li>

                            <li>
                                <a href="${pageContext.request.contextPath}/project.action?currentPage=${pageBean.totalPage}&studentNumber=${studentNumber}&projectId=${projectId}&projectLevel=${projectLevel}&projectScore=${projectScore}&projectTime=${projectTime}&projectType=${projectType}">
...
<script type="text/javascript">
    ...
    function importInformation()
    {
        ...
        var  practiceLevel=$("#practiceLevel").val();
        var  date=$("#date").val();
        var practiceType=$("#practiceType").val();
        var  practiceScore=$("#practiceScore").val();
        var  practiceName=$("#practiceName").val();
        var url="practiceDownload.action?"+"faculty="+faculty+"&"+"major="+major+"&"+"grade="+grade+"&"+"date="+date+"&"+"name=大学生创新创业训练项目"+"&"+"practiceName="+practiceName+"&"+"practiceLevel="+practiceLevel+"&"+"practiceType="+practiceType+"&"+"practiceScore="+practiceScore;
        window.open(url);
    }
</script>
</body>
