                    ...
                    <div class="col-xs-12" id="searchForm" style="display: none">
                        ...
                        <form class="form-horizontal" role="form"
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> 学号 </label>
                                <div class="col-sm-2" id="form-field-1-1">
                                    <input type="text"  onkeyup="value=value.replace(/[^\d]/g,'')"  class="form-control" id="form-field-select-1" name="stuNum"/>
                                </div>
                                <label class="col-sm-1 control-label no-padding-right" for="date">日期</label>
                                <div class="col-sm-2">
                                    <div class="input-group ">
                                        <select class="form-control date-picker" name="date" id="date" readonly>
                                            <option  value=""></option>
                                        </select>
