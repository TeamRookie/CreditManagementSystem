        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <C:forEach items="${typeList}" var="item">
                        <li class="">
                            <a href="${pageContext.request.contextPath}/${item.informationurl}">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <C:forEach items="${typeList}" var="item">
                        <li class="">
                            <a href="${pageContext.request.contextPath}/${item.rulesurl}.action">
                                <i class="menu-icon fa fa-caret-right"></i> ${item.name}
                            </a>
                            <b class="arrow"></b>
                        </li>
                    ...
                    <div class="message-footer clearfix">
                        ...
                        <div class="pull-right">
                            ...
                            <ul class="pagination middle">
                                <li>
                                    <a href="${pageContext.request.contextPath}/associationRules.action?currentPage=1"><i class="ace-icon fa fa-step-backward middle"></i></a>
                                </li>

                                <li >

                                    <a href="${pageContext.request.contextPath}/associationRules.action?currentPage=${pageBean.currentPage-1}"> <i class="ace-icon fa fa-caret-left bigger-140 middle"></i> </a>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/associationRules.action?currentPage=${pageBean.currentPage+1}">
                                        <i class="ace-icon fa fa-caret-right bigger-140 middle"></i>
                                    </a>
                                </li>

                                <li>
                                    <a href="${pageContext.request.contextPath}/associationRules.action?currentPage=${pageBean.totalPage}">
